...
namespace Lesson04.Controllers
{
    public class MobilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand,Model,Quantity,Price,Image")] Mobile mobile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,Model,Quantity,Price,Image")] Mobile mobile)
        {
            if (id != mobile.Id)
            {
                return NotFound();
